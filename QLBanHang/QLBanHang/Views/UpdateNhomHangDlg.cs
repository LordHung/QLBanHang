...
{
    public partial class UpdateNhomHangDlg : Form
    {
        public UpdateNhomHangDlg()
        {
            InitializeComponent();
        }

        public UpdateNhomHangDlg(string maLoaiSanPham)
        {
            InitializeComponent();
        ...
        private void UpdateData()
        {
            ...
            if (_ctrlLoaiSanPham.UpdateData(_loaiSanPham))
            {
