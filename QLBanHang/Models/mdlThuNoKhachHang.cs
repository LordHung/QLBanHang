...
namespace QLBanHang.Models
{
    class mdlThuNoKhachHang
    {
        ...
        public bool AddData(clsThuNoKhachHang thuNoKhachHang)//Không add idPhieNhap tại đây
        {
            ...
            +"GhiChu,idNhanVien,idCuaHang,SoPhieu,idPhieuNhap) "
            + "VALUES (N'{0}',cast(N'{1}' as datetime),N'{2}',{3},N'{4}',N'{5}',N'{6}',N'{7}',{8})"
                 , thuNoKhachHang.IdKhachHang
                 , thuNoKhachHang.NgayThu.ToString("yyyy-MM-dd hh:mm:ss.FFF")
                 , thuNoKhachHang.SoTien
                 , (thuNoKhachHang.IdHoaDon != 0) ? "'" + thuNoKhachHang.IdHoaDon.ToString() + "'" : "null"
                 , thuNoKhachHang.GhiChu
                 , thuNoKhachHang.IdNhanVien
                 , thuNoKhachHang.IdCuaHang
                 , thuNoKhachHang.SoPhieu
                 , (thuNoKhachHang.IdPhieuNhap != 0) ? "'" + thuNoKhachHang.IdPhieuNhap.ToString() + "'" : "null"
                 );
