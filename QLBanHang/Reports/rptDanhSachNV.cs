...
namespace QLBanHang.Reports {
    public partial class rptDanhSachNV : Form {
        public rptDanhSachNV() {
            InitializeComponent();
        }

        private void rptDanhSachNV_Load(object sender, EventArgs e) {
            ...
            // TODO: This line of code loads data into the 'qL.tbNhanVien' table. You can move, or remove it, as needed.
            this.tbNhanVienTableAdapter.Fill(this.qL.tbNhanVien);
