...
namespace QLBanHang.Reports {
    public partial class rptDanhSachNSX : Form {
        public rptDanhSachNSX() {
            InitializeComponent();
        }

        private void rptDanhSachNSX_Load(object sender, EventArgs e) {
            ...
            // TODO: This line of code loads data into the 'qL.tbNhaSanXuat' table. You can move, or remove it, as needed.
            this.tbNhaSanXuatTableAdapter.Fill(this.qL.tbNhaSanXuat);

            reportViewer1.RefreshReport();
            //gọi RefreshReport() để bắt đầu hiển thị
            reportViewer1.LocalReport.DisplayName = "DanhSachNSX";
